            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Photo Taken Today</h5>
                  ...
                  <tr>
                    ...
                    <th scope="row">
                      <div class="media align-items-center">
                        ...
                        <div class="media-body">
                          <span class="name mb-0 text-sm">Creative Title 2</span>
                        </div>
                      </div>
                    </th>
                  ...
                  <tr>
                    ...
                    <th scope="row">
                      <div class="media align-items-center">
                        ...
                        <div class="media-body">
                          <span class="name mb-0 text-sm">Creative Title 3</span>
                        </div>
                      </div>
                    </th>
                  ...
                  <tr>
                    ...
                    <th scope="row">
                      <div class="media align-items-center">
                        ...
                        <div class="media-body">
                          <span class="name mb-0 text-sm">Creative Title 4</span>
                        </div>
                      </div>
                    </th>
                    <!-- Second Column --------------------------------------------------------->

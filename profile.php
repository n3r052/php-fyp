              ...
              <div class="row justify-content-center">
                <div class="col-lg-3 order-lg-2">
                  <div class="card-profile-image">
                    <a href="#">
                      <img src="assets/img/theme/team-6.jpg" class="rounded-circle">
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div class="card-body pt-0">
                ...
                <div class="text-center">
                  <div class="h5 font-weight-300">
                    <i class="ni location_pin mr-2"></i>User ID - Email
                  </div>
                  <div class="h5 mt-4">
                    <i class="ni business_briefcase-24 mr-2"></i>Admin - Company
                  </div>
                </div>
              </div>
            </div>
                ...
                <form>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input type="email" id="input-email" class="form-control" placeholder="john@example.com">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input type="text" id="input-first-name" class="form-control" placeholder="First name" value="John">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-control-label" for="input-last-name">Last name</label>
                          <input type="text" id="input-last-name" class="form-control" placeholder="Last name" value="Doe">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="pl-lg-4">
                    <div class="form-group">
                      ...
                      <textarea rows="4" class="form-control" placeholder="A few words about you ...">A Hoshiyomi</textarea>
                    </div>
                  </div>
